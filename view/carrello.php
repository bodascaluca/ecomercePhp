            ...
            if($result2->num_rows > 0){
                ...
                while ($row = $result2 -> fetch_assoc()){
                    ...
                    <ul>
                        ...
                        <li>
                            <img src="imgProdotto" src="../img/<?php echo $row["immagine"] ?>" alt="">
                        </li>

                        <li>
                            <?php echo $row["prezzo"]. " X "  ?>
                        </li>

                        <li>
                            <form action="../controller/remove_product.php" method="POST">
                                <input name="id_carrello" hidden type="<?php echo $row["id"]; ?>">  
                ...
                ?>
                 ...
                 <form action="ordini.php" method="post">
                    <button name="order_confim" class="btn btn-primary" type="submite">Conferma ordine</button>
                 </form>
                 <?php 
                }else{
